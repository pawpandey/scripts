...
def build_unity_player(input_str):
    ...
    # Find log file
    unity_log_file = "/Users/oren/Library/Logs/Unity/Editor.log"
...
if __name__ == '__main__':
    input_str = """-quit -batchmode -executeMethod CommandLine.PerformBuild -platform=Android -buildconfig=DebugOptimized -makeobb=False"""
    # input_str = """-quit -batchmode -executeMethod CommandLine.PerformBuild -platform=Android -buildconfig=Optimized -makeobb=False"""
    # input_str = sys.argv[1]
    build_unity_player(input_str)
